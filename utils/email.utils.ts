...
export async function sendVerificationEmail(email: string, token: string) {
  ...
  await transporter.sendMail({
    from: '"ProxiMeet" sylw3st3r.projects@gmail.com',
    to: email,
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
            <tr>
              <td style="background-color: #4a90e2; padding: 20px; color: white; text-align: center;">
                <h1 style="margin: 0;">ProxiMeet</h1>
              </td>
            </tr>
            <tr>
...
export async function sendPasswordResetEmail(email: string, token: string) {
  const appVerificationLink = `http://localhost:3000/password-reset/${token}`;
  await transporter.sendMail({
    from: '"ProxiMeet" sylw3st3r.projects@gmail.com',
    to: email,
    subject: "Verify your Email",
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
            ...
            <tr>
              <td style="padding: 30px;">
                ...
                <p style="font-size: 16px; color: #555;">Hi there,</p>
                <p style="font-size: 16px; color: #555;">
                  Please reset your password by clicking the button below. This link will expire in 1 hour.
                </p>
                <p style="text-align: center; margin: 30px 0;">
                  <a href="${appVerificationLink}" style="background-color: #4a90e2; color: white; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">
                    Reset password
